        ...
        <div>
          <div className="heading">
            <div className="title">
              ...
              <span style={{color:"#198dc1"}}><FaMoneyBillTrendUp/></span>
            </div>
          ...
          <div className={classes.header}>
                ...
                <div className={classes.print}>
                    {/* <label>طباعة</label> */}
                    <span onClick={()=>window.print()} style={{color:"#198dc1"}}><FaPrint/></span>
                </div>
            </div>
            <div>
            <table className={classes.customers}>
                ...
                <tr>
                    ...
                    <td><time>{formatDate(new Date(item.bookings.date))}</time></td>
                    <td><p>{formatTime(new Date(item.bookings.date))}</p></td>
