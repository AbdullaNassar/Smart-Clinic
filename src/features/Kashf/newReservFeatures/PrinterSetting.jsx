    ...
    <div className={classes.info}>
      ...
      <div className={classes.row}>
        <input
          ...
          id="opposite"
          type="checkbox"
          checked={opposite || all}
          onChange={() => setOpposite((e) => !e)}
        />
