...
import { deleteBooking,  getBooking,  getTodayBooking, updateBooking } from "../../services/apiBooking";
...
function TodayBooking(){
  ...
  const formattedDate = new Intl.DateTimeFormat('ar', optionss).format(new Date());
        ...
        <div>
            <div className={classes.header}>
                    ...
                    <div className={classes.date}>
                      ...
                      <span style={{color:"#04AA6D"}}><FaCalendarDays/></span>
                    </div>
                    <div className={classes.ring}>
                    <span className={classes.spn} ><FaBell/></span>
                    <button onClick={()=>{
                      setCur(p=>p+1);
                      // generateRingSound();
                    }}>التالي</button>
