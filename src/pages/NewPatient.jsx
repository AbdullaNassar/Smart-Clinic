...
const {errors}=formState;
    ...
    return(
      ...
      <div className={classes.formGroup}>
        ...
        <input type="text" id="name" className={classes.input} {...register('name', {required: "ادخل اسم المريض"} )} />
        </FormRow>
      </div>
      <div className={classes.formGroup}>
        ...
        <input type="text" id="phone" className={classes.input} {...register('phone')} />
      </div>
      <div className={classes.formGroup}>
        <label htmlFor="age" className={classes.label}>
          السن:
        </label>
        <input type="number" id="age" className={classes.input} {...register('age')} />
      </div>
      <div className={classes.formGroup}>
      ...
      <div className={classes.formGroup}>
        ...
        <textarea id="notes" className={classes.textarea} {...register('notes')} />
      </div>
      <button type="submit" className={classes.button}>تسجيل مريض جديد</button>
    </form>
    );
}
